...
{
    public class AddDigitalContentToUserWatchListDTValidation : AbstractValidator<AddDigitalContentToUserWatchListDTO>
    {
        public AddDigitalContentToUserWatchListDTValidation() { 
