...
namespace EyeScenceApp.Infrastructure.Repositories
{
    public class ProducerRepository : GenericRepository<Producer>, IProducerRepository
    {
        ...
        #region Method(s)
        public async override Task<Producer?> GetByIdAsync(Guid id, bool AsTracking = false)
        {
            var query = _dbContext.Producers.Include(d => d.Images)
        ...
        public async override Task<IEnumerable<Producer>> GetAllAsync(bool isTracked = false)
        {
            var query = _dbContext.Producers.Include(d => d.Images)
                                                        .ThenInclude(imges => imges.Image);
        ...
        public async Task<IEnumerable<Producer>> GetByNameAsync(string name, bool isTracked = false)
        {
